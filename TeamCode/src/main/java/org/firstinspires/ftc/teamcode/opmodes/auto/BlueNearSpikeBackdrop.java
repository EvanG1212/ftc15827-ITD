...
@Autonomous(name = "Blue NEAR/LEFT Spike Backdrop", group =".Main Blue")
public class BlueNearSpikeBackdrop extends RobotOpMode {
        ...
        switch (propPosition) {
            case Left:
              ...
              //  bot.claw.rightClose();
                ...
                new AutoComGyroMecDrive(this, -40.0, 0.0, 0.3).Run();
                sleep(1000);
            ...
            case Middle:
                ...
                new AutoComGyroMecDrive(this, -40.0, 0.0, 0.3).Run();
                new AutoComGyroMecDrive(this, 0.0, -4.0, 0.3).Run();
                new AutoComGyroMecDrive(this, 4.0,0.0,0.3).Run();

                new AutoComGyroMecDrive(this, 0.0,50.0,0.3).Run();
                new AutoComGyroMecDrive(this, -8.0,0.0,0.3).Run();
                break;
            case Right:
                new AutoComGyroMecDrive(this, 20.0,0.0,0.3).Run();
              ...
              //  bot.claw.rightClose();
                ...
                new AutoComEncoderTurn(this, 10.5,0.3).Run();
                new AutoComGyroMecDrive(this, -40.0, 0.0, 0.3).Run();
                new AutoComGyroMecDrive(this, 0.0, -16.0, 0.3).Run();

                sleep(1000);
                new AutoComGyroMecDrive(this, 4.0,0.0,0.3).Run();
                new AutoComGyroMecDrive(this, 0.0,70.0,0.3).Run();
                new AutoComGyroMecDrive(this, -8.0,0.0,0.3).Run();
                break;
        }
    }
